              ...
              <div className="tab-1-content-inner">
                <div>
                  <p className="text-lg">
                    ...
                    Commitment. Cancel at Anytime
                  </p>
                  <Link to="/netflix-show-case" className="btn btn-lg">
          ...
          <div className="container">
            ...
            >
              <div className="tab-2-content-top">
                ...
                <Link to="/netflix-showcase" className="btn btn-lg">
                  Watch Free For 30 Days
                </Link>
              </div>
              <div className="tab-2-content-bottom">
                <div>
                  ...
                  <p className="text-dark">
                    Smart TV's, Playstation,Apple TV,Blueray,Air,Xbox,Chromecast
                    and more
                  </p>
                </div>
                <div>
          ...
          <div className="container">
            ...
            >
              ...
              <table className="table">
                ...
                <tbody>
                  <tr>
                    <td>Monthly price after free month end on 6/19/2024</td>
                    <td>$6.99</td>
                    <td>$11.99</td>
                    <td>$15.99</td>
                  </tr>
